...
SELECT * FROM SPENDING INNER JOIN TYPE_SPENDING ON SPENDING.idSpending = TYPE_SPENDING.spending INNER JOIN TYPE ON TYPE_SPENDING.type = TYPE.idType WHERE owner = adri229 ORDER BY name